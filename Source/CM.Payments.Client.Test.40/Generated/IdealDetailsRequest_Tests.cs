...
namespace CM.Payments.Client.Test
{
	...
	public partial class IdealDetailsRequestTests : BaseJsonConvertTests
	{
		public TestContext TestContext { get; set; }

		[TestMethod]
		public void IdealDetailsRequest()
		{
			var obj = new IdealDetailsRequest
			{
				CallbackUrl = "Lorum_930",
				CancelledUrl = "Lorum_27",
				Description = "Lorum_928",
				ExpiredUrl = "Lorum_716",
				FailedUrl = "Lorum_521",
				IssuerId = "Lorum_591",
